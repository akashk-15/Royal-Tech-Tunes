...
public class ExistingUser extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(bcname, javax.swing.GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmail, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(46, 46, 46)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(bcname, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String mnumber = num.getText();
        DataLogic dl = new DataLogic();
        ResultSet rs = dl.excistCustomer(mnumber);
        try {
            String out1 = rs.getString("name");
            String out2 = rs.getString("mnumber");
            String out3 = rs.getString("email");
            cname.setText(out1);
            cnum.setText(out2);
            cmail.setText(out3);
        } catch (SQLException ex) {
            Logger.getLogger(ExistingUser.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String mnumber = cnum.getText();
        String email = cmail.getText();
        String bikename = bcname.getText();
        if (bikename.equals("")) {
            JOptionPane.showMessageDialog(null, "BIKE MODEL NAME IS MANDOTORY ");
        } else {
            DataLogic dl = new DataLogic();
            if (dl.existcustomer(name, mnumber, email, bikename)) {
            ...
            Book bi = new Book();
            bi.unname.setText(cname.getText());
            bi.mnnumber.setText(cnum.getText());
            bi.ID.setText(cmail.getText());
            bi.bike.setText(bcname.getText());
